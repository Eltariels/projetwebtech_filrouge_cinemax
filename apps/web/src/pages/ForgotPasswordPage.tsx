...
const s: Record<string, React.CSSProperties> = {
    ...
    title:   { fontSize: "1.25rem", fontWeight: 400, marginBottom: "0.5rem", color: "var(--text)" },
    ...
    success: { background: "rgba(39,174,96,0.1)", border: "1px solid rgba(39,174,96,0.4)", borderRadius: 6, padding: "0.75rem 1rem", marginBottom: "1rem", color: "#27ae60", fontSize: "0.875rem", lineHeight: 1.5 },
